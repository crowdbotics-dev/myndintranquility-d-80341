...
## Project Structure
    ...
    ├── myndintranquility_d_80341  # Django project configurations
...
1. Clone this repo and `cd myndintranquility_d_80341`
...
2. Clone this repo and `cd myndintranquility_d_80341`
